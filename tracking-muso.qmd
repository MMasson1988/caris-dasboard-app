...
```{python, echo=FALSE}
muso_group = pd.read_excel("../outputs/MUSO/muso_group_final.xlsx",sheet_name=0)
```
...
```{python, echo=FALSE}
muso_ben = pd.read_excel("../outputs/MUSO/muso_ben_actif.xlsx",sheet_name=0)
```
...
::: card
```{python, echo=FALSE}
ben_avec_ppi = pd.read_excel("../outputs/MUSO/muso_ben_with_ppi.xlsx",sheet_name=0)
