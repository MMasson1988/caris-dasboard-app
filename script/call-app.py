...
end_date = pd.to_datetime('2025-12-31')  # Fixed to today's date
...
def main():
    ...
    agent_data_visite = (
        ...
        .sort_values(by='Performances', ascending=False)
    )
    ...
    export_multiple_pivot_tables_to_excel(pivot_tables, f'outputs/SERVICES/Tableau_des_Performances {today_date}.xlsx', sheet_names, titles, delete_row=None)
        # Écrit 'agent_data' dans le même classeur daté
    ...
    src_path = os.path.join("outputs", f"Table_des_Performances_{today_str}.xlsx")
    src_sheet = "Tableau des Appels et Visites"

    dst_path = f"outputs/SERVICES/Tableau_des_Performances {today_date}.xlsx"
